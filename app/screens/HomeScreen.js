...
function HomeScreen({route, navigation}) {
  ...
  const AllRoute = () => routeTemplate({data: allData});
  const ChairRoute = () => routeTemplate({data: chairData});
  const TableRoute = () => routeTemplate({data: tableData});
  const SofaRoute = () => routeTemplate({data: sofaData});
  const LampRoute = () => routeTemplate({data: lampData});
    ...
    <TouchableOpacity
      ...
      onPress={() =>
        navigation.navigate('Detail', {
          item: item,
          userId: userId,
          dimension: findItemInDimensionData(item.id),
        })
      }>
      ...
      <View style={styles.footerView}>
        <View style={styles.footerContainer}>
          <TouchableOpacity style={styles.iconContainer} onPress={() => {}}>
            ...
            <Text style={styles.iconName} color={colors.darkgray}>
              Home
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
